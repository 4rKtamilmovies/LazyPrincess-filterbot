...
API_ID = int(environ['API_ID', '14897265')
API_HASH = environ['API_HASH', '1eae017d2fbbfb2b8ec40a61fa1a9078']
BOT_TOKEN = environ['BOT_TOKEN', '5967465873:AAGaxbtQY3DHjb1Ouj0n1E6NywsWbraFgrM']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '14897265').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001791435166')
auth_grp = environ.get('AUTH_GROUP', '-1001778620883')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adaa™](https://t.me/Hdnewtamilmovies4K)</b> \n\n <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [MoviesAdda™](https://t.me/hdnewtamilmovies4K)</b> ↭  🔥")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','@Hdnewtamilmovie4K') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+3oEtjF8Th585YmZl") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/Hdnewtamilmovies4K"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Hdnewtamilmovies4K"
